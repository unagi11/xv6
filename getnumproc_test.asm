...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 90 07 00 00       	mov    $0x790,%ebx
        while(*s != 0){
 ...
 5e1:	a1 3c 0a 00 00       	mov    0xa3c,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 3c 0a 00 00       	mov    %eax,0xa3c
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6bf:	73 47                	jae    708 <malloc+0x98>
    ...
    if(p == freep)
 6c1:	39 05 3c 0a 00 00    	cmp    %eax,0xa3c
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
}
 ...
 729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 3c 0a 00 00 40 	movl   $0xa40,0xa3c
 737:	0a 00 00 
 73a:	c7 05 40 0a 00 00 40 	movl   $0xa40,0xa40
 741:	0a 00 00 
    base.s.size = 0;
 744:	b8 40 0a 00 00       	mov    $0xa40,%eax
 749:	c7 05 44 0a 00 00 00 	movl   $0x0,0xa44
 750:	00 00 00 
