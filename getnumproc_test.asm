...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 70 07 00 00       	mov    $0x770,%ebx
        while(*s != 0){
 ...
 5c1:	a1 1c 0a 00 00       	mov    0xa1c,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 1c 0a 00 00       	mov    %eax,0xa1c
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
    ...
    if(p == freep)
 6a1:	39 05 1c 0a 00 00    	cmp    %eax,0xa1c
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 1c 0a 00 00    	mov    %edx,0xa1c
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 1c 0a 00 00 20 	movl   $0xa20,0xa1c
 717:	0a 00 00 
 71a:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 721:	0a 00 00 
    base.s.size = 0;
 724:	b8 20 0a 00 00       	mov    $0xa20,%eax
 729:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 730:	00 00 00 
