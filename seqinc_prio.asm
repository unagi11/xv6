  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  17:	8b 41 04             	mov    0x4(%ecx),%eax
    if (argc < 2)
  1a:	0f 8e af 00 00 00    	jle    cf <main+0xcf>
    {
  ...
  a0:	83 c6 01             	add    $0x1,%esi
            set_prio(priority);
  a3:	56                   	push   %esi
  a4:	e8 e1 04 00 00       	call   58a <set_prio>
            printf(1, "%d\n", get_prio());
  a9:	e8 d4 04 00 00       	call   582 <get_prio>
  ae:	83 c4 0c             	add    $0xc,%esp
  b1:	50                   	push   %eax
  b2:	68 d3 09 00 00       	push   $0x9d3
  b7:	6a 01                	push   $0x1
  b9:	e8 82 05 00 00       	call   640 <printf>
            delay(20);
  be:	c7 04 24 14 00 00 00 	movl   $0x14,(%esp)
  c5:	e8 26 01 00 00       	call   1f0 <delay>
            exit();
  ca:	e8 e3 03 00 00       	call   4b2 <exit>
        printf(1, "test-case <number-of-children>\n");
  cf:	50                   	push   %eax
  d0:	50                   	push   %eax
  d1:	68 00 0a 00 00       	push   $0xa00
  d6:	6a 01                	push   $0x1
  d8:	e8 63 05 00 00       	call   640 <printf>
        exit();
  dd:	e8 d0 03 00 00       	call   4b2 <exit>
    for (int i = 0; i < N; i++)
  e2:	be 14 00 00 00       	mov    $0x14,%esi
